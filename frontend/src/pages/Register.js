      ...
      <RegisterCard>
        ...
        <Form onSubmit={handleSubmit}>
          <InputGroup>
            ...
            />
            {formErrors.username && <div style={{ color: 'var(--error)', fontSize: '0.8rem', marginTop: '0.25rem' }}>{formErrors.username}</div>}
          </InputGroup>
          ...
          <InputGroup>
            ...
            <Input
              ...
              onChange={handleChange}
            />
            {formErrors.confirmPassword && <div style={{ color: 'var(--error)', fontSize: '0.8rem', marginTop: '0.25rem' }}>{formErrors.confirmPassword}</div>}
          </InputGroup>
